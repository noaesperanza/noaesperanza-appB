-- ========================================
-- SQL SEGURO PARA SUPABASE - Nôa Esperanza 2.0
-- Versão otimizada para evitar deadlocks
-- Execute este arquivo COMPLETO no Supabase SQL Editor
-- ========================================

-- ========================================
-- PASSO 1: EXTENSÕES (Execute primeiro)
-- ========================================
CREATE EXTENSION IF NOT EXISTS "pgcrypto";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ========================================
-- PASSO 2: TABELAS (Execute segundo)
-- ========================================
...
-- ========================================
-- PASSO 3: HABILITAR RLS (Execute terceiro)
-- ========================================
...
-- ========================================
-- PASSO 4: POLÍTICAS RLS (Execute quarto)
-- ========================================
...
-- ========================================
-- PASSO 5: ÍNDICES (Execute quinto - separadamente)
-- ========================================

-- Índices para documentos_mestres
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_documentos_type ON documentos_mestres(type);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_documentos_category ON documentos_mestres(category);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_documentos_active ON documentos_mestres(is_active);

-- Índices para interacoes_noa
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_interacoes_usuario ON interacoes_noa(usuario);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_interacoes_data ON interacoes_noa(data DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_interacoes_origem ON interacoes_noa(origem);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_interacoes_hash ON interacoes_noa(hash_integridade);

-- Índices para mensagens_noa
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_mensagens_interacao ON mensagens_noa(interacao_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_mensagens_role ON mensagens_noa(role);

-- Índices para auditoria_simbolica
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_auditoria_hash ON auditoria_simbolica(hash_coletivo);
