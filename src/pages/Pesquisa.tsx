          ...
          <div className="flex gap-4 py-1 px-4">
            ...
            <div className="w-72 flex-shrink-0">
              <div className="premium-card p-2 sticky top-4 h-[calc(100vh-8rem)] overflow-y-auto z-10">
                ...
                <div className="mb-2">
                  <h2 className="text-xs font-bold mb-0.5 text-premium">Projetos de Pesquisa</h2>
                  ...
                  {projects.map(project => (
                    ...
                    >
                      ...
                      <div className="flex items-start space-x-1 mb-1">
                        <div
                          className={`p-0.5 rounded bg-gradient-to-r ${project.color} text-white flex-shrink-0`}
                        >
                ...
                <div className="space-y-1">
                  ...
                  <div className="premium-card p-1.5 text-center">
                    ...
                    <p className="text-xs text-gray-300 mb-1">
                      ...
                      cannabis medicinal na prática clínica.
                    </p>
                    <button className="premium-button text-xs px-1 py-0.5 w-full">
                      📕 Baixar eBook
                    </button>
                  </div>
              ...
              <section className="mb-3">
                <div className="text-center mb-2">
                  ...
                  <p className="text-xs text-gray-300 leading-tight">
                    Projetos inovadores que aplicam a metodologia AEC em diferentes contextos, desde
                    pesquisa aplicada até intervenções comunitárias globais.
                  </p>
                </div>
              </section>
                ...
                <div className="premium-card p-1 mb-2">
                  ...
                  <div className="grid md:grid-cols-3 gap-1">
                    ...
                    >
                      ...
                      <h4 className="text-xs font-semibold text-premium group-hover:text-green-400 transition-colors">
                        Gravação
                      </h4>
                  ...
                  <div className="grid grid-cols-2 gap-0.5">
                    <div className="flex items-start gap-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-300">
                          Role-playing clínico, análise triaxial.
                        </p>
                      </div>
                    </div>
