  ...
  return (
    <div className="h-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 h-full">
        {/* Header */}
        <div className="mb-4">
          <Link to="/app/admin" className="inline-block text-yellow-400 hover:text-yellow-300 mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-medium text-white text-sm">
                      {metrics.approvedPayments.toLocaleString()}
                    </div>
              ...
              <tbody>
                {recentTransactions.slice(0, 3).map(transaction => (
                  <tr key={transaction.id} className="border-b border-gray-700">
                    ...
                    <td className="py-1 text-gray-300 text-xs">
                      {getMethodText(transaction.method)}
                    </td>
                    <td className="py-1">
                      <span
                        className={`px-1 py-0.5 rounded-full text-xs font-medium ${getStatusColor(transaction.status)}`}
                      >
