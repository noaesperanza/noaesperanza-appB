-- 🧹 SCRIPT DE LIMPEZA GPT BUILDER
-- Remove objetos conflitantes antes de executar o setup
...
SELECT 'Limpeza concluída! Agora execute o gpt_builder_database_ultra_safe.sql' as status;
